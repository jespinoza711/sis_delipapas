            ...
            <?php foreach ($cajas as $row) { ?>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label>Usuario: *</label>
                        <select id="codi_rol" class="form-control" name="usfi_ccd"><?php foreach ($usuarios as $r) { ?> <option value="<?= $r->codi_usu ?>"><?= $r->nomb_usu ?></option> <?php } ?></select>
                    </div>
                    <div class="form-group"><label>Saldo inicial (S/.): *</label> <?= form_input($safi_ccd, $row['safi_ccd']) ?> </div>
