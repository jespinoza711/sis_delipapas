<div class="row" id="cpo_regcajachica_all">
    <div class="col-lg-12 col-xs-12">
        <div class="col-md-11" style="margin-left: 4%">
            <div id="panel-cie" class="panel panel-primary">
                
                <div class="panel-heading">
                    <h3 class="panel-title"> Todos los gastos de caja chica </h3>
                </div>
                ...
                <div class="panel-body">
                    ...
                    <a href="<?= base_url('cajachica') ?>"><button type="button" class="btn btn-info"><i class="fa fa-plus"></i>&nbsp;&nbsp;Registrar nuevo gasto</button></a>
                    <br><br>
                    <div class="table-responsive">
                        <table id="table_regcajachica_all" class="table table-bordered">
                            <thead>
                                <tr>
                                    <th>C&oacute;digo</th>
...
<div class="modal fade" id="ModalEditarRegistroCajaChica" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog" style="width: 30%;">
        <div class="modal-content" style="border-color: #428bca; border-style: inset;">
            ...
            <?= form_open(base_url('cajachicaeditall'), $form_regcajachica_edit) ?>
