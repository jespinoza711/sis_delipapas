        ...
        <div class="col-md-11" style="margin-left: 4%;">
            <div id="panel-cie" class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <?= form_open(base_url('regcajachica'), $form_cajachica) ?>

                    <div class="modal-body">

                        <div class="form-group"><label># Caja: *</label><?= form_input($codi_cac) ?></div>
                        <div class="form-group">
                            <label>Empleado: *</label>
                            <select id="codi_rol" class="form-control" name="soli_gas"><?php foreach ($empleado as $r) { ?> <option value="<?= $r->codi_emp ?>"><?= $r->nomb_emp . ' ' . $r->apel_emp ?></option> <?php } ?></select>
                        </div>
                        <div class="form-group">
