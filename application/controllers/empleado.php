...
class empleado extends CI_Controller {
    ...
    public function index() {
        if (!$this->logged()) {
            ...
            if ($this->session->userdata('form_empleado') == false) {
                if ($this->input->post('registrar')) {
                    ...
                    $this->session->set_userdata('form_empleado', true);
                ...
                $this->session->set_userdata('mensaje_emp', 'El formulario ya ha sido ingresado.');
                $this->session->set_userdata('ripo_mensaje_emp', 'danger');
                $this->session->unset_userdata('form_empleado');
